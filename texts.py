...
bodies = {
    ...
    'ffos': "It refers to the portion of Funds From Operations (FFO) allocated to each share. This metric is an insightful tool for assessing a REIT's profitability.",
    'ffo_payout': "It denotes the percentage of FFO distributed as dividends. A lower payout ratio may suggest a REIT's potential for more substantial growth.",
    'ffo_margin': "This is the percentage of total revenue that remains after all operating expenses have been paid. Higher FFO Margins signify more efficient REIT operations.",
